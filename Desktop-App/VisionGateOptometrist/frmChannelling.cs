...
{
    public partial class frmChannelling : Form
    {
        public frmChannelling()
        {
            InitializeComponent();
        ...
        private void frmChannelling_Load(object sender, EventArgs e)
        {
            pnlChannelling.BackColor = Color.FromArgb(200, 240, 240, 240);
