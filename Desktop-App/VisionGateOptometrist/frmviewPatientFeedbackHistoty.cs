...
{
    public partial class frmviewPatientFeedbackHistoty : Form
    {
        public frmviewPatientFeedbackHistoty()
        {
            InitializeComponent();
        ...
        private void frmviewPatientFeedbackHistoty_Load(object sender, EventArgs e)
        {
