...
{
    public partial class frmPaymentCancellationApproval : Form
    {
        public frmPaymentCancellationApproval()
        {
            InitializeComponent();
        ...
        private void frmPaymentCancellationApproval_Load(object sender, EventArgs e)
        {
