...
{
    public partial class frmViewForgotPasswordRequest : Form
    {
        ...
        public frmViewForgotPasswordRequest()
        {
            InitializeComponent();
        ...
        private void frmViewForgotPasswordRequest_Load(object sender, EventArgs e)
        {
        ...
        private void LoadForgotPasswordRequests()
        {
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    // Query to fetch all records from tblRequestForgotPassword
                    string query = "SELECT ID, Name, Telephone FROM tblRequestForgotPassword";
            ...
            {
                MessageBox.Show($"Error loading Forgot Password Requests: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
