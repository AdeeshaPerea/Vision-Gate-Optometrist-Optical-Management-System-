...
{
    public partial class frmViewVisionTestResult : Form
    {
        ...
        public frmViewVisionTestResult()
        {
            InitializeComponent();
        ...
        private void frmViewVisionTestResult_Load(object sender, EventArgs e)
        {
            // Remove title bar and borders
            this.FormBorderStyle = FormBorderStyle.None;

            // Load Vision Test Results into DataGridView
            LoadVisionTestResults();
        }

        private void LoadVisionTestResults()
        {
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    // Query to fetch all Vision Test Results
                    string query = "SELECT VisionTestNumber, TestType, PatientID, PatientName, TestDate, TestResult FROM tblManageVisionTestResult";
            ...
            {
                MessageBox.Show($"Error loading vision test results: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
