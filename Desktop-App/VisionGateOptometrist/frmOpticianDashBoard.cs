...
{
    public partial class frmOpticianDashBoard : Form
    {
        ...
        public frmOpticianDashBoard()
        {
            InitializeComponent();
        }

        private void frmOpticianDashBoard_Load(object sender, EventArgs e)
        {
        ...
        private void LoadEmployeeName()
        {
            try
            {
                ...
                {
                    con.Open();
                    // Query to fetch the name of the employee with EmployeeID = 8
                    string query = "SELECT Name FROM tblManageEmployee WHERE EmployeeID = 8";
        ...
        private void frmOpticianDashBoard_Click(object sender, EventArgs e)
        {
