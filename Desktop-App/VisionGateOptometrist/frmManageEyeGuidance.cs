...
{
    public partial class frmManageEyeGuidance : Form
    {
        ...
        public frmManageEyeGuidance()
        {
            InitializeComponent();
            this.BackColor = ColorTranslator.FromHtml("#EBF1F5"); // Set form background color
        }

        private void frmManageEyeGuidance_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string query = "INSERT INTO tblManageEyeGuidance (PatientID, PatientName, Category, Date, Description) " +
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string query = "UPDATE tblManageEyeGuidance SET PatientName = @PatientName, Category = @Category, Date = @Date, Description = @Description " +
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string query = "DELETE FROM tblManageEyeGuidance WHERE PatientID = @PatientID";
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        cmd.Parameters.AddWithValue("@PatientID", txtPatientID.Text);
                        cmd.ExecuteNonQuery();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string query = "SELECT * FROM tblManageEyeGuidance WHERE PatientID = @PatientID";
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
