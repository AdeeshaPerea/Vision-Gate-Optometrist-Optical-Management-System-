...
{
    public partial class frmViewDeliveryInformation : Form
    {
        public frmViewDeliveryInformation()
        {
            InitializeComponent();
        ...
        private void frmViewDeliveryInformation_Load(object sender, EventArgs e)
        {
