...
{
    public partial class frmOptometristDashBoard : Form
    {
        ...
        public frmOptometristDashBoard()
        {
            InitializeComponent();
        }

        private void frmOptometristDashBoard_Load(object sender, EventArgs e)
        {
        ...
        private void LoadEmployeeName()
        {
            try
            {
                ...
                {
                    con.Open();
                    // Query to fetch the name of the employee with EmployeeID = 6
                    string query = "SELECT Name FROM tblManageEmployee WHERE EmployeeID = 6";
        ...
        private void frmOptometristDashBoard_Click(object sender, EventArgs e)
        {
