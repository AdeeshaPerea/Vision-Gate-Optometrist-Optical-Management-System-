...
{
    public partial class frmViewSystemFeedbackHistory : Form
    {
        public frmViewSystemFeedbackHistory()
        {
            InitializeComponent();
        ...
        private void frmViewSystemFeedbackHistory_Load(object sender, EventArgs e)
        {
