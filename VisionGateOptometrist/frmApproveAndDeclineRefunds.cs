...
{
    public partial class frmApproveAndDeclineRefunds : Form
    {
        public frmApproveAndDeclineRefunds()
        {
            InitializeComponent();
        ...
        private void frmApproveAndDeclineRefunds_Load(object sender, EventArgs e)
        {
